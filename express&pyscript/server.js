...
app.get('/evaluation', (req, res) => {
    const pythonProcess = spawn('python', ['./evaluation.py']); // Adjust the path as needed
...
app.post('/recommendations-from-liked_A', (req, res) => {
    const likedMovies = req.body;
    // Spawn the Python process
    const pythonProcess = spawn('python', ['process_movie_info.py']);
    let dataString = '';
    ...
    // Send the liked movies data to the Python script
    pythonProcess.stdin.write(JSON.stringify({ function: 'generate_cf_recommendations', likedMovies: likedMovies }));
    pythonProcess.stdin.end();
...
app.post('/recommendations-from-feedback_A', (req, res) => {
    const feedbackMovies = req.body;
    // Spawn the Python process
    const pythonProcess = spawn('python', ['process_movie_info.py']);
    let dataString = '';
    ...
    // Send the liked movies data to the Python script
    pythonProcess.stdin.write(JSON.stringify({ function: 'generate_cf_adjusted_recommendations', feedbackMovies: feedbackMovies }));
    pythonProcess.stdin.end();
...
app.post('/recommendations-from-liked_B', (req, res) => {
    const likedMovies = req.body;
    // Spawn the Python process
    const pythonProcess = spawn('python', ['process_movie_info.py']);
    let dataString = '';
    ...
    // Send the liked movies data to the Python script
    pythonProcess.stdin.write(JSON.stringify({ function: 'generate_cbf_recommendations', likedMovies: likedMovies }));
    pythonProcess.stdin.end();
...
app.post('/recommendations-from-feedback_B', (req, res) => {
    const feedbackMovies = req.body;
    // Spawn the Python process
    const pythonProcess = spawn('python', ['process_movie_info.py']);
    let dataString = '';
    ...
    // Send the liked movies data to the Python script
    pythonProcess.stdin.write(JSON.stringify({ function: 'generate_cbf_adjusted_recommendations', feedbackMovies: feedbackMovies }));
    pythonProcess.stdin.end();
...
app.post('/submit-user-feedback', (req, res) => {
    const userFeedback = req.body;
    // Spawn the Python process
    const pythonProcess = spawn('python', ['user_feedback.py']);
    let dataString = '';
    console.log(JSON.stringify({ function: 'submit_user_feedback', userFeedback: userFeedback }))

    // Send the liked movies data to the Python script
    pythonProcess.stdin.write(JSON.stringify({ function: 'submit_user_feedback', userFeedback: userFeedback }));
    pythonProcess.stdin.end();
    // Collect data from script
    pythonProcess.stdout.on('data', function(data) {
        dataString += data.toString();
...
app.get('/get-history-feedback', (req, res) => {
    const pythonProcess = spawn('python', ['./get_history_feedback.py']); // Adjust the path as needed
